    ...
    <section className="bg-[var(--color-warm-white)] py-20">
      <Container className="max-w-sm mx-auto">
        <div className="bg-white rounded-[0.75rem] border border-[var(--color-warm-gray-1)] p-8">
          <h1 className="font-[family-name:var(--font-heading)] font-bold text-[1.75rem] text-[var(--color-primary-dark)] mb-6 text-center">Welcome Back</h1>
          ...
          <p className="text-center text-[0.8125rem] text-[var(--color-warm-gray-3)] mt-4">
            Don&apos;t have an account? <Link href="/auth/register" className="text-[var(--color-primary)] font-medium">Create one</Link>
          </p>
        </div>
      </Container>
    </section>
